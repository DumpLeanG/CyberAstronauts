                        ...
                        foreach ($columns_array as $arr) {
                            ...
                            if ($index_col > 1){
                                if($arr['Field'] === 'img') {
                                    ...
                                    <input type='tel' class='admin_create_section_block_form_row_input' name='".$arr['Field']."' value='".$info[$arr['Field']]."'>
                                </div>";
                                } elseif ($arr['Field'] === 'email_address') {
                                    echo "<div class='admin_create_section_block_form_row'>
                                    <label class='admin_create_section_block_form_row_txt'>Электронный адрес</label>
                                    <input type='email' class='admin_create_section_block_form_row_input' name='".$arr['Field']."' value='".$info[$arr['Field']]."'>
                                </div>";
                                    ...
                                    <input type='time' class='admin_create_section_block_form_row_input' name='".$arr['Field']."' value='".$info[$arr['Field']]."'>
                                </div>";
                                ...
                                } elseif ($arr['Field'] === 'id_discount') {
                                    $select_discounts = "SELECT * FROM discounts"; 
                                    ...
                                    <div class='admin_create_section_block_form_row_block'>
                                        ...
                                        echo "<option></option>";
                                    foreach ($discounts_array as $ar){
                                        if($ar['id_discount'] === $info[$arr['Field']]) {
                                ...
                                } elseif ($arr['Field'] === 'desrciption') {
                                    echo "<div class='admin_create_section_block_form_row'>
                                    <label class='admin_create_section_block_form_row_txt'>Описание</label>
                                    <textarea class='admin_create_section_block_form_row_input' name='".$arr['Field']."'>".$info[$arr['Field']]."</textarea>
                                </div>";
                                } elseif ($arr['Field'] === 'price') {
                                    echo "<div class='admin_create_section_block_form_row'>
                                    <label class='admin_create_section_block_form_row_txt'>Цена</label>
                                    <input type='number' class='admin_create_section_block_form_row_input' name='".$arr['Field']."' value='".$info[$arr['Field']]."'>
                                </div>";
                                    ...
                                    foreach ($tournament_participants_array as $ar){
                                        if($ar['id_tournament_participant'] === $info[$arr['Field']]) {
                                            echo "<option selected>".$ar['team']."</option>";
                                        } else {
                                            echo "<option>".$ar['team']."</option>";
                                        }
                                    }
                                        echo "</select>
                                        <img src='assets/images/arrow.svg' class='admin_create_section_block_form_row_block_img'>
                                    ...
                                    <input type='text' class='admin_create_section_block_form_row_input' name='".$array['Field']."' value='".$info[$arr['Field']]."'>
                                </div>";
                                } elseif ($arr['Field'] === 'id_game') {
                                    ...
                                    foreach ($games_array as $ar){
                                        if($ar['id_game'] === $info[$arr['Field']]) {
                                            echo "<option selected>".$ar['name']."</option>";
                                        } else {
                                            echo "<option>".$ar['name']."</option>";
                                        }
                                    ...
                                    foreach ($genres_array as $ar){
                                        if($ar['id_genre'] === $info[$arr['Field']]) {
                                            echo "<option selected>".$ar['name']."</option>";
                                        } else {
                                            echo "<option>".$ar['name']."</option>";
                                        }
